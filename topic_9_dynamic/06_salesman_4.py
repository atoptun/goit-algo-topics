...
# часова складність O(E log E), де E - кількість ребер у графі

# Часова складність алгоритму переважно залежить від швидкості сортування ребер, яка зазвичай 
# O(E log E) де E— кількість ребер у графі. 
# Сам процес знаходження мінімального остовного дерева має часову складність 
# O(E log V), де V — кількість вершин.
